...
export const sobreMi= "Bueno primero me presento, me llamo Narela un gusto! Soy de Argentina, Bs.As, soy desarrolladora web Jr, con muchas ganas de seguir aprendiendo de este mundo de la programación, y poder encontrar mi primer empleo IT. "
...
export const tecnologias = <p>-JavaScript <br/> -HTML <br/> -CSS <br/>  -ReactJs <br/>  -NodeJs <br/>  -Express <br/> -Sequelize</p>

export const contacto = <p>LinkendIn <a href="https://www.linkedin.com/in/narela99/" target="_blank" rel="noopener noreferrer"> Ir a mi perfil</a><br/>
Mail: narela315@gmail.com
<FormContact/></p>

const link = "https://www.linkedin.com/in/narela99/"

export const respuestas = [sobreMi]
